...
static void ingenic_jpeg_device_run(void *priv)
{
...

	{
		...
		struct vb2_v4l2_buffer *src_v4l2_buf = v4l2_m2m_next_src_buf(ctx->m2m_ctx);
		struct vb2_v4l2_buffer *dst_v4l2_buf = v4l2_m2m_next_dst_buf(ctx->m2m_ctx);

		struct vb2_buffer *src_buf = &src_v4l2_buf->vb2_buf;
		struct vb2_buffer *dst_buf = &dst_v4l2_buf->vb2_buf;
